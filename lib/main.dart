  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        toolbarHeight: 30,
        backgroundColor: Color.fromARGB(255, 245, 109, 19),
        elevation: 0,
        actions: [
          Padding(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                color: Color.fromARGB(255, 238, 115, 15),
                borderRadius:
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Color.fromARGB(255, 226, 104, 4),
